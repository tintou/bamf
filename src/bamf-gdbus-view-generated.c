...
static const _ExtendedGDBusArgInfo _bamf_dbus_item_application_method_info_supported_mime_types_OUT_ARG_mime_types =
{
  {
    -1,
    (gchar *) "mime_types",
...
static const _ExtendedGDBusArgInfo * const _bamf_dbus_item_application_method_info_supported_mime_types_OUT_ARG_pointers[] =
{
  &_bamf_dbus_item_application_method_info_supported_mime_types_OUT_ARG_mime_types,
  NULL
};

static const _ExtendedGDBusMethodInfo _bamf_dbus_item_application_method_info_supported_mime_types =
{
  {
    -1,
    (gchar *) "SupportedMimeTypes",
    NULL,
    (GDBusArgInfo **) &_bamf_dbus_item_application_method_info_supported_mime_types_OUT_ARG_pointers,
    NULL
  },
...
static const _ExtendedGDBusArgInfo _bamf_dbus_item_application_method_info_focusable_child_OUT_ARG_path =
{
  {
    -1,
    (gchar *) "path",
...
static const _ExtendedGDBusArgInfo * const _bamf_dbus_item_application_method_info_focusable_child_OUT_ARG_pointers[] =
{
  &_bamf_dbus_item_application_method_info_focusable_child_OUT_ARG_path,
  NULL
};

static const _ExtendedGDBusMethodInfo _bamf_dbus_item_application_method_info_focusable_child =
{
  {
    -1,
    (gchar *) "FocusableChild",
    NULL,
    (GDBusArgInfo **) &_bamf_dbus_item_application_method_info_focusable_child_OUT_ARG_pointers,
    NULL
  },
...
static const _ExtendedGDBusMethodInfo * const _bamf_dbus_item_application_method_info_pointers[] =
{
  ...
  &_bamf_dbus_item_application_method_info_supported_mime_types,
  &_bamf_dbus_item_application_method_info_application_type,
  &_bamf_dbus_item_application_method_info_application_menu,
  &_bamf_dbus_item_application_method_info_focusable_child,
  NULL
};
...
static const _ExtendedGDBusArgInfo _bamf_dbus_item_application_signal_info_supported_mime_types_changed_ARG_dnd_mimes =
{
  {
    -1,
    (gchar *) "dnd_mimes",
...
static const _ExtendedGDBusArgInfo * const _bamf_dbus_item_application_signal_info_supported_mime_types_changed_ARG_pointers[] =
{
  &_bamf_dbus_item_application_signal_info_supported_mime_types_changed_ARG_dnd_mimes,
  NULL
};

static const _ExtendedGDBusSignalInfo _bamf_dbus_item_application_signal_info_supported_mime_types_changed =
{
  {
    -1,
    (gchar *) "SupportedMimeTypesChanged",
    (GDBusArgInfo **) &_bamf_dbus_item_application_signal_info_supported_mime_types_changed_ARG_pointers,
    NULL
  },
...
static const _ExtendedGDBusSignalInfo * const _bamf_dbus_item_application_signal_info_pointers[] =
{
  ...
  &_bamf_dbus_item_application_signal_info_supported_mime_types_changed,
  NULL
};
...
bamf_dbus_item_application_default_init (BamfDBusItemApplicationIface *iface)
{
   ...
   *
   * If a signal handler returns %TRUE, it means the signal handler will handle the invocation (e.g. take a reference to @invocation and eventually call bamf_dbus_item_application_complete_supported_mime_types() or e.g. g_dbus_method_invocation_return_error() on it) and no order signal handlers will run. If no signal handler handles the invocation, the %G_DBUS_ERROR_UNKNOWN_METHOD error is returned.
   *
   * Returns: %TRUE if the invocation was handled, %FALSE to let other signal handlers run.
   */
   ...
   *
   * If a signal handler returns %TRUE, it means the signal handler will handle the invocation (e.g. take a reference to @invocation and eventually call bamf_dbus_item_application_complete_focusable_child() or e.g. g_dbus_method_invocation_return_error() on it) and no order signal handlers will run. If no signal handler handles the invocation, the %G_DBUS_ERROR_UNKNOWN_METHOD error is returned.
   *
   * Returns: %TRUE if the invocation was handled, %FALSE to let other signal handlers run.
   */
...
/**
 * bamf_dbus_item_application_emit_supported_mime_types_changed:
 * @object: A #BamfDBusItemApplication.
...
{
  g_signal_emit_by_name (object, "supported-mime-types-changed", arg_dnd_mimes);
}
...
/**
 * bamf_dbus_item_application_call_supported_mime_types:
 * @proxy: A #BamfDBusItemApplicationProxy.
 * @cancellable: (allow-none): A #GCancellable or %NULL.
 * @callback: A #GAsyncReadyCallback to call when the request is satisfied or %NULL.
 * @user_data: User data to pass to @callback.
 ...
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
 * You can then call bamf_dbus_item_application_call_supported_mime_types_finish() to get the result of the operation.
 *
 * See bamf_dbus_item_application_call_supported_mime_types_sync() for the synchronous, blocking version of this method.
 */
void
bamf_dbus_item_application_call_supported_mime_types (
    BamfDBusItemApplication *proxy,
...
/**
 * bamf_dbus_item_application_call_supported_mime_types_finish:
 * @proxy: A #BamfDBusItemApplicationProxy.
 * @out_mime_types: (out): Return location for return parameter or %NULL to ignore.
 * @res: The #GAsyncResult obtained from the #GAsyncReadyCallback passed to bamf_dbus_item_application_call_supported_mime_types().
 * @error: Return location for error or %NULL.
 *
 * Finishes an operation started with bamf_dbus_item_application_call_supported_mime_types().
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * bamf_dbus_item_application_call_supported_mime_types_sync:
 * @proxy: A #BamfDBusItemApplicationProxy.
 * @out_mime_types: (out): Return location for return parameter or %NULL to ignore.
 * @cancellable: (allow-none): A #GCancellable or %NULL.
 * @error: Return location for error or %NULL.
 ...
 *
 * See bamf_dbus_item_application_call_supported_mime_types() for the asynchronous version of this method.
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * bamf_dbus_item_application_call_focusable_child:
 * @proxy: A #BamfDBusItemApplicationProxy.
 * @cancellable: (allow-none): A #GCancellable or %NULL.
 * @callback: A #GAsyncReadyCallback to call when the request is satisfied or %NULL.
 * @user_data: User data to pass to @callback.
 ...
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
 * You can then call bamf_dbus_item_application_call_focusable_child_finish() to get the result of the operation.
 *
 * See bamf_dbus_item_application_call_focusable_child_sync() for the synchronous, blocking version of this method.
 */
void
bamf_dbus_item_application_call_focusable_child (
    BamfDBusItemApplication *proxy,
...
/**
 * bamf_dbus_item_application_call_focusable_child_finish:
 * @proxy: A #BamfDBusItemApplicationProxy.
 * @out_path: (out): Return location for return parameter or %NULL to ignore.
 * @res: The #GAsyncResult obtained from the #GAsyncReadyCallback passed to bamf_dbus_item_application_call_focusable_child().
 * @error: Return location for error or %NULL.
 *
 * Finishes an operation started with bamf_dbus_item_application_call_focusable_child().
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * bamf_dbus_item_application_call_focusable_child_sync:
 * @proxy: A #BamfDBusItemApplicationProxy.
 * @out_path: (out): Return location for return parameter or %NULL to ignore.
 * @cancellable: (allow-none): A #GCancellable or %NULL.
 * @error: Return location for error or %NULL.
 ...
 *
 * See bamf_dbus_item_application_call_focusable_child() for the asynchronous version of this method.
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * bamf_dbus_item_application_complete_supported_mime_types:
 * @object: A #BamfDBusItemApplication.
 * @invocation: (transfer full): A #GDBusMethodInvocation.
...
/**
 * bamf_dbus_item_application_complete_focusable_child:
 * @object: A #BamfDBusItemApplication.
 * @invocation: (transfer full): A #GDBusMethodInvocation.
...
static void
_bamf_dbus_item_application_on_signal_supported_mime_types_changed (
    BamfDBusItemApplication *object,
    const gchar *const *arg_dnd_mimes)
{
  BamfDBusItemApplicationSkeleton *skeleton = BAMF_DBUS_ITEM_APPLICATION_SKELETON (object);
...
bamf_dbus_item_application_skeleton_iface_init (BamfDBusItemApplicationIface *iface)
{
  ...
  iface->supported_mime_types_changed = _bamf_dbus_item_application_on_signal_supported_mime_types_changed;
}
