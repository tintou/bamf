...
char             * bamf_window_get_app_object_path (BamfWindow *self);

char             * bamf_window_get_window_object_path (BamfWindow *self);

char             * bamf_window_get_menubar_object_path (BamfWindow *self);
