  ...
  if (chrome_app_url && chrome_app_url->len > 2)
    {
      ...
      /* Chop off the last 2 characters as appurl hints are in the form off www.google.com_/
       * we are only interested in www.google.com
       */
      chrome_app_url = g_string_truncate (chrome_app_url, 
                                          (gsize) (chrome_app_url->len - 2));
