...
/* BOOLEAN:UINT64,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.WOYCXU:1) */
...
/* BOOLEAN:STRING,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.WOYCXU:2) */
...
/* BOOLEAN:STRING,INT,POINTER (/tmp/dbus-binding-tool-c-marshallers.WOYCXU:3) */
