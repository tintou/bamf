...
/* BOOLEAN:UINT64,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.FLHLXU:1) */
...
/* BOOLEAN:STRING,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.FLHLXU:2) */
...
/* BOOLEAN:STRING,INT,POINTER (/tmp/dbus-binding-tool-c-marshallers.FLHLXU:3) */
