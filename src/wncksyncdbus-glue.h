...
/* BOOLEAN:UINT64,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.CDH9XU:1) */
...
/* BOOLEAN:STRING,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.CDH9XU:2) */
...
/* BOOLEAN:STRING,INT,POINTER (/tmp/dbus-binding-tool-c-marshallers.CDH9XU:3) */
