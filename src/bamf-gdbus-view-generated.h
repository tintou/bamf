...
struct _BamfDBusItemApplicationIface
{
  ...
  gboolean (*handle_dnd_mimes) (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation);

  gboolean (*handle_focus_child) (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation);
...
void bamf_dbus_item_application_complete_dnd_mimes (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation,
...
void bamf_dbus_item_application_complete_focus_child (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation,
    const gchar *path);
...
void bamf_dbus_item_application_emit_dnd_mimes_changed (
    BamfDBusItemApplication *object,
    const gchar *const *arg_dnd_mimes);
...
void bamf_dbus_item_application_call_dnd_mimes (
    BamfDBusItemApplication *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_application_call_dnd_mimes_finish (
    BamfDBusItemApplication *proxy,
    gchar ***out_dnd_mimes,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_application_call_dnd_mimes_sync (
    BamfDBusItemApplication *proxy,
    gchar ***out_dnd_mimes,
    GCancellable *cancellable,
    GError **error);
...
void bamf_dbus_item_application_call_focus_child (
    BamfDBusItemApplication *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_application_call_focus_child_finish (
    BamfDBusItemApplication *proxy,
    gchar **out_path,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_application_call_focus_child_sync (
    BamfDBusItemApplication *proxy,
    gchar **out_path,
    GCancellable *cancellable,
    GError **error);
