...
struct _BamfDBusItemWindowIface
{
  ...
  gboolean (*handle_application_id) (
    BamfDBusItemWindow *object,
    GDBusMethodInvocation *invocation);

  gboolean (*handle_dbus_menu_object_path) (
    BamfDBusItemWindow *object,
    GDBusMethodInvocation *invocation);
  ...
  gboolean (*handle_unique_bus_name) (
    BamfDBusItemWindow *object,
    GDBusMethodInvocation *invocation);
...
void bamf_dbus_item_window_complete_application_id (
    BamfDBusItemWindow *object,
    GDBusMethodInvocation *invocation,
    const gchar *id);

void bamf_dbus_item_window_complete_unique_bus_name (
    BamfDBusItemWindow *object,
    GDBusMethodInvocation *invocation,
    const gchar *name);

void bamf_dbus_item_window_complete_dbus_menu_object_path (
    BamfDBusItemWindow *object,
    GDBusMethodInvocation *invocation,
    const gchar *object_path);
...
void bamf_dbus_item_window_call_application_id (
    BamfDBusItemWindow *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_window_call_application_id_finish (
    BamfDBusItemWindow *proxy,
    gchar **out_id,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_window_call_application_id_sync (
    BamfDBusItemWindow *proxy,
    gchar **out_id,
    GCancellable *cancellable,
    GError **error);

void bamf_dbus_item_window_call_unique_bus_name (
    BamfDBusItemWindow *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_window_call_unique_bus_name_finish (
    BamfDBusItemWindow *proxy,
    gchar **out_name,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_window_call_unique_bus_name_sync (
    BamfDBusItemWindow *proxy,
    gchar **out_name,
    GCancellable *cancellable,
    GError **error);

void bamf_dbus_item_window_call_dbus_menu_object_path (
    BamfDBusItemWindow *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_window_call_dbus_menu_object_path_finish (
    BamfDBusItemWindow *proxy,
    gchar **out_object_path,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_window_call_dbus_menu_object_path_sync (
    BamfDBusItemWindow *proxy,
    gchar **out_object_path,
    GCancellable *cancellable,
    GError **error);
