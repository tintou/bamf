...
struct _BamfDBusItemApplicationIface
{
  ...
  gboolean (*handle_application_menu) (
  ...
  gboolean (*handle_focusable_child) (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation);
  ...
  gboolean (*handle_supported_mime_types) (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation);
  ...
  void (*supported_mime_types_changed) (
    BamfDBusItemApplication *object,
...
void bamf_dbus_item_application_complete_supported_mime_types (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation,
...
void bamf_dbus_item_application_complete_application_menu (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation,
    const gchar *busname,
    const gchar *objectpath);

void bamf_dbus_item_application_complete_focusable_child (
    BamfDBusItemApplication *object,
    GDBusMethodInvocation *invocation,
    const gchar *path);
...
void bamf_dbus_item_application_emit_supported_mime_types_changed (
    BamfDBusItemApplication *object,
    const gchar *const *arg_dnd_mimes);
...
void bamf_dbus_item_application_call_supported_mime_types (
    BamfDBusItemApplication *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_application_call_supported_mime_types_finish (
    BamfDBusItemApplication *proxy,
    gchar ***out_mime_types,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_application_call_supported_mime_types_sync (
    BamfDBusItemApplication *proxy,
    gchar ***out_mime_types,
    GCancellable *cancellable,
    GError **error);
...
void bamf_dbus_item_application_call_application_menu (
    BamfDBusItemApplication *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_application_call_application_menu_finish (
    BamfDBusItemApplication *proxy,
    gchar **out_busname,
...
gboolean bamf_dbus_item_application_call_application_menu_sync (
    BamfDBusItemApplication *proxy,
    gchar **out_busname,
    gchar **out_objectpath,
    GCancellable *cancellable,
...
void bamf_dbus_item_application_call_focusable_child (
    BamfDBusItemApplication *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_application_call_focusable_child_finish (
    BamfDBusItemApplication *proxy,
    gchar **out_path,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_application_call_focusable_child_sync (
    BamfDBusItemApplication *proxy,
    gchar **out_path,
    GCancellable *cancellable,
    GError **error);
...
void bamf_dbus_item_window_complete_get_pid (
    BamfDBusItemWindow *object,
    GDBusMethodInvocation *invocation,
    guint pid);
...
void bamf_dbus_item_window_call_get_pid (
    BamfDBusItemWindow *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_window_call_get_pid_finish (
    BamfDBusItemWindow *proxy,
    guint *out_pid,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_window_call_get_pid_sync (
    BamfDBusItemWindow *proxy,
    guint *out_pid,
    GCancellable *cancellable,
    GError **error);
...
struct _BamfDBusItemTabIface
{
  ...
  const gchar * (*get_desktop_id) (BamfDBusItemTab *object);

  gboolean  (*get_is_foreground_tab) (BamfDBusItemTab *object);

  const gchar * (*get_location) (BamfDBusItemTab *object);

  guint64  (*get_xid) (BamfDBusItemTab *object);
...
/* D-Bus method call completion functions: */
void bamf_dbus_item_tab_complete_raise (
    BamfDBusItemTab *object,
    GDBusMethodInvocation *invocation);

void bamf_dbus_item_tab_complete_close (
    BamfDBusItemTab *object,
    GDBusMethodInvocation *invocation);

void bamf_dbus_item_tab_complete_request_preview (
    BamfDBusItemTab *object,
    GDBusMethodInvocation *invocation,
    const gchar *data);
...
/* D-Bus method calls: */
void bamf_dbus_item_tab_call_raise (
    BamfDBusItemTab *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_tab_call_raise_finish (
    BamfDBusItemTab *proxy,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_tab_call_raise_sync (
    BamfDBusItemTab *proxy,
    GCancellable *cancellable,
    GError **error);

void bamf_dbus_item_tab_call_close (
    BamfDBusItemTab *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_tab_call_close_finish (
    BamfDBusItemTab *proxy,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_tab_call_close_sync (
    BamfDBusItemTab *proxy,
    GCancellable *cancellable,
    GError **error);

void bamf_dbus_item_tab_call_request_preview (
    BamfDBusItemTab *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean bamf_dbus_item_tab_call_request_preview_finish (
    BamfDBusItemTab *proxy,
    gchar **out_data,
    GAsyncResult *res,
    GError **error);

gboolean bamf_dbus_item_tab_call_request_preview_sync (
    BamfDBusItemTab *proxy,
    gchar **out_data,
    GCancellable *cancellable,
    GError **error);
...
/* D-Bus property accessors: */
const gchar *bamf_dbus_item_tab_get_location (BamfDBusItemTab *object);
gchar *bamf_dbus_item_tab_dup_location (BamfDBusItemTab *object);
void bamf_dbus_item_tab_set_location (BamfDBusItemTab *object, const gchar *value);

guint64 bamf_dbus_item_tab_get_xid (BamfDBusItemTab *object);
void bamf_dbus_item_tab_set_xid (BamfDBusItemTab *object, guint64 value);

const gchar *bamf_dbus_item_tab_get_desktop_id (BamfDBusItemTab *object);
gchar *bamf_dbus_item_tab_dup_desktop_id (BamfDBusItemTab *object);
void bamf_dbus_item_tab_set_desktop_id (BamfDBusItemTab *object, const gchar *value);

gboolean bamf_dbus_item_tab_get_is_foreground_tab (BamfDBusItemTab *object);
void bamf_dbus_item_tab_set_is_foreground_tab (BamfDBusItemTab *object, gboolean value);
